...
### Environment Setup
Set the OpenCV installation path:
```cmd
...
3. **Configure with CMake**
   ...
   Or specify OpenCV path explicitly:
   ```cmd
...
### OpenCV DLLs
Ensure OpenCV DLLs are in your PATH or copy them to the executable directory:
```
...
- [ ] Step 4: ONNX Runtime integration for deep learning models
